...
* A request to /api/:date? with a valid date should return a JSON object with an utc key that is a string of the input date in the format: Thu, 01 Jan 1970 00:00:00 GMT
...
- [] I want to use a semantic versioning and a changelog with a standard-version 
- [] I want to deploy the JavaScript app to AWS Lambda or even EKS
- [] I want to add metrics and play with Graphana
- [] I want to add performance tests and play with InfluxDB
